  ...
  const faqsData = [
    {
      ...
      answer:
        "Easily log your exercises, sets, reps, and weights. Track your progress over time with clear charts and stats.",
    },
    {
      question: "Can I follow a custom training plan?",
      answer:
        "Yes! Your coach can create personalized workout plans tailored to your goals and fitness level.",
    },
    {
      question: "Is there guidance on proper exercise form?",
      answer:
        "Absolutely. Each exercise comes with detailed instructions, images, and video demonstrations to ensure you perform them safely.",
    },
    {
      question: "How do I monitor my progress?",
      answer:
        "Track metrics like strength improvements, endurance, body measurements, and overall performance to stay motivated.",
    },
    {
      question: "Does the app support diet and nutrition tracking?",
      answer:
        "Yes! Log meals, track calories, and follow nutrition guidance from your coach to complement your workout plan.",
    },
  ];
    ...
    <section id="FAQ">
      <div className="flex flex-col items-center text-center text-slate-800 px-6 md:px-16 lg:px-24 text-sm max-w-6xl mx-auto mt-20">
        ...
        <p className="text-sm text-slate-500 mt-4 max-w-sm">
          Find answers to common questions about using our gym app, tracking
          workouts, and following your coach’s plans.
        </p>
